...
namespace DirectOutputCSharpWrapper {
	...
	public class DirectOutput {
		...
		private delegate HResult DirectOutput_RegisterDeviceCallback([MarshalAs(UnmanagedType.FunctionPtr)]DeviceCallback callback, IntPtr target);
		...
		private delegate HResult DirectOutput_RegisterSoftButtonCallback(IntPtr device, [MarshalAs(UnmanagedType.FunctionPtr)]SoftButtonCallback callback, IntPtr target);
		private delegate HResult DirectOutput_RegisterPageCallback(IntPtr device, [MarshalAs(UnmanagedType.FunctionPtr)]PageCallback callback, IntPtr target);
		...
		private delegate HResult DirectOutput_SetImageFromFile(IntPtr device, Int32 page, Int32 index, Int32 fileNameLength, [MarshalAsAttribute(UnmanagedType.LPWStr)] String filename);
		private delegate HResult DirectOutput_StartServer(IntPtr device, Int32 fileNameLength, [MarshalAsAttribute(UnmanagedType.LPWStr)] String filename, out IntPtr serverId, out SRequestStatus status);
		private delegate HResult DirectOutput_CloseServer(IntPtr device, Int32 serverId, out SRequestStatus status);
		private delegate HResult DirectOutput_SendServerMsg(IntPtr device, Int32 serverId, Int32 request, Int32 page, Int32 inBufferSize, byte[] inBuffer, Int32 outBufferSize, out byte[] outBuffer, out SRequestStatus status);
		private delegate HResult DirectOutput_SendServerFile(IntPtr device, Int32 serverId, Int32 request, Int32 page, Int32 cbInHdr, IntPtr pvInHdr, Int32 fileNameLength, [MarshalAsAttribute(UnmanagedType.LPWStr)] String filename, Int32 cbOut, out IntPtr pvOut, out SRequestStatus status);
		private delegate HResult DirectOutput_SaveFile(IntPtr device, Int32 page, Int32 dwFile, Int32 fileNameLength, [MarshalAsAttribute(UnmanagedType.LPWStr)] String filename, out SRequestStatus status);
		private delegate HResult DirectOutput_DisplayFile(IntPtr device, Int32 page, Int32 dwIndex, Int32 dwFile, out SRequestStatus status);
		private delegate HResult DirectOutput_DeleteFile(IntPtr device, Int32 page, Int32 dwFile, out SRequestStatus status);
		...
		private void InitializeLibraryFunctions() {
			...
			registerDeviceCallback = DllHelper.GetFunction<DirectOutput_RegisterDeviceCallback>(hModule, "DirectOutput_RegisterDeviceCallback");
			...
			registerSoftButtonCallback = DllHelper.GetFunction<DirectOutput_RegisterSoftButtonCallback>(hModule, "DirectOutput_RegisterSoftButtonCallback");
			registerPageCallback = DllHelper.GetFunction<DirectOutput_RegisterPageCallback>(hModule, "DirectOutput_RegisterPageCallback");
			...
			setImageFromFile = DllHelper.GetFunction<DirectOutput_SetImageFromFile>(hModule, "DirectOutput_SetImageFromFile");
